...
Jeśli chcesz tylko uruchomić sterowanie, zacznij od [06-node-red.md](06-node-red.md). Wróć tutaj, gdy będziesz potrzebować szczegółów.
...
Zobacz: [`REVERSE_ENGINEERING.md`](../REVERSE_ENGINEERING.md)
