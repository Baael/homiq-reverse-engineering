...
### Szybki test:
```bash
# Sprawdź czy Moxa odpowiada
ping 10.10.20.201
nc -zv 10.10.20.201 4001
```
...
- [Szybki start](01-szybki-start.md) — sprawdź czy system żyje
- [Dostęp do Moxy](03-dostep-do-moxy.md) — jak się podłączyć
- [FAQ (protokół)](09-faq-protokol.md) — problemy z komunikacją
- [Rozwiązywanie problemów](07-rozwiazywanie-problemow.md) — diagnostyka techniczna
